...
public abstract class AbstractRouting extends AsyncTask<Void, Void, List<Route>> {
    protected final List<anulom.executioner.com.anulom.library.RoutingListener> alisteners;
    ...
    protected AbstractRouting(anulom.executioner.com.anulom.library.RoutingListener listener) {
        this.alisteners = new ArrayList<>();
        registerListener(listener);
    }

    public void registerListener(anulom.executioner.com.anulom.library.RoutingListener mListener) {
        if (mListener != null) {
    ...
    protected void dispatchOnStart() {
        for (anulom.executioner.com.anulom.library.RoutingListener mListener : alisteners) {
    ...
    protected List<Route> doInBackground(Void... voids) {
        ...
        try {
            result = new anulom.executioner.com.anulom.library.GoogleParser(constructURL()).parse();
