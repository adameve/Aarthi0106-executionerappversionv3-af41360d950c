...
public class marriagenew extends Fragment implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    public static marriagenew thisToday = null;
                    ...
                    public void onClick(View v) {
                        ...
                        b1.setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                mTimePicker = new TimePickerDialog(marriagenew.this.getContext(), new TimePickerDialog.OnTimeSetListener() {
...
//
    ...
    private void viewDetails() {
        ...
        if (GenericMethods.marriagenewwww.equals("true")) {

            getAlldataList = GenericMethods.getAllmarriagenewlist1;
        ...
        } else if (GenericMethods.marriagenewwww.equals("false")) {
            getAlldataList = db.getAllmarriagenewList(db);
