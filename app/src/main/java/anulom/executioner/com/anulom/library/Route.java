...
public class Route {
    ...
    private List<anulom.executioner.com.anulom.library.Segment> segments;
    ...
    public void setSegments(List<anulom.executioner.com.anulom.library.Segment> segments) {
    ...
    public void addSegment(final anulom.executioner.com.anulom.library.Segment s) {
        segments.add(s);
    }

    public List<anulom.executioner.com.anulom.library.Segment> getSegments() {
        return segments;
    }
