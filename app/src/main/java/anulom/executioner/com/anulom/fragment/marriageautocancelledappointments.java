...
public class marriageautocancelledappointments extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.viewautocancelledappointments, container, false);
    ...
    private void createAdpt() {
        ...
        adpt = new ArrayAdapter<String>(getActivity().getApplicationContext(), R.layout.taskautocancelled1, reportkey) {

            public View getView(final int position, final View convertView, ViewGroup parent) {
                // TODO Auto-generated method stub
                final LayoutInflater inflater = LayoutInflater.from(getContext());
                final View v = inflater.inflate(R.layout.taskautocancelled, parent,false);
                ...
                assignby.setText(getAlldataList.get(position).get("contact_person"));
    ...
    private void viewDetails() {
        ...
        reportkey.clear();
            ...
            getAlldataList = db.getAllmarriageautocancelledappointments(db);
