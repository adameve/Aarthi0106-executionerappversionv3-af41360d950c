...
//
//
//public class salesAutocancelledappointments extends Fragment {
...
//
//
//        adpt = new ArrayAdapter<String>(getActivity().getApplicationContext(), R.layout.taskautocancelled, reportkey) {
//
//            public View getView(final int position, final View convertView, ViewGroup parent) {
//                // TODO Auto-generated method stub
//                final LayoutInflater inflater = LayoutInflater.from(getContext());
//                final View v = inflater.inflate(R.layout.taskautocancelled1, parent,false);
//
...
//
//
//            getAlldataList = db.getAllsalesautocancelledappointments(db);
//
