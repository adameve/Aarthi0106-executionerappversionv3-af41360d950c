...
//import anulom.executioner5.com3.anulom.fragment.salescompleted;
...
//
//
//public class Salesacvrservice extends Service {
//
//
...
//            ArrayList<HashMap<String, String>> acvrreportlist = db.getsalesAcvrReport(db);
//
...
//                        runOnUiThread(new Runnable() {
//                            public void run() {
//                                Toast.makeText(Salesacvrservice.this, "From Sales ACVR,Please Contact Support Team ", Toast.LENGTH_LONG).show();
//                            }
//                        });
//                    }
//                    if (strStatus.equals("-1")) {
//                        runOnUiThread(new Runnable() {
//                            public void run() {
//                                Toast.makeText(Salesacvrservice.this, "From Sales ACVR,Contact support Team", Toast.LENGTH_LONG).show();
//                            }
//                        });
//
//                    }
