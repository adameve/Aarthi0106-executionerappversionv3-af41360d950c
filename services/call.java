                ...
                if (!strResponsePost.equals("")) {
                    ...
                    if (strStatus.equals(status)) {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(call.this, "From Call,Please Contact Support Team ", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                    if (strStatus.equals("-1")) {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(call.this, "From Call,Contact support Team", Toast.LENGTH_LONG).show();
                            }
                        });
