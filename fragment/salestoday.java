...
//
//public class salestoday extends Fragment  {
//
//    public static salestoday thisToday = null;
//    String year, month, day, hour, sdate, min, id, owner, tenant, w1, w2, rkey, timevalue, timevalue1 = "", not_id, from = "Today", biocontent = "", content = "", o_content = "", t_content = "", w1_content = "", w2_content = "",
//            o_ = "", t_ = "", w1_ = "", w2_ = "", Date, poststatus, content1 = "Today", valu = "Sales", O_ = "", T_ = "", W_ = "", POA_ = "", AW_ = "", news = " Sales Today's Appointments", A, nodetails1 = "No Today Appointments!!!";
//    int year1, month1, day1, hour1, t_hour1=0,t_min1=0,h2, h3, click, min1, id1, count = 0, flag, intervalvalue, repeat;
...
//                                    mTimePicker = new TimePickerDialog(salestoday.this.getContext(), new TimePickerDialog.OnTimeSetListener() {
//                                        @Override
...
//
//
//                            if (appid.equals(db.getAllsalesTodayList(db).get(position).get("appid"))) {
//
...
//                                    int count4 = sqldb2.update(DBManager.TableInfo.TABLE_SALES_APPOINTMENT, values2, DBManager.TableInfo.db_sales_appointment_id + "=?", new String[]{db.getAllsalesTodayList(db).get(position).get("appid")});
//                                    sqldb2.close();
//
...
//
//        if (GenericMethods.salestodayyy.equals("true")) {
//
//            getAlldataList = GenericMethods.getAllsalestodaylist1;
//
...
//            }
//        } else if (GenericMethods.salestodayyy.equals("false")) {
//            getAlldataList = db.getAllsalesTodayList(db);
//
//            for (int i = 0; i < getAlldataList.size(); i++) {
//
//
...
//
//        String doc_id = getAlldataList.get(position).get("Did");
//
